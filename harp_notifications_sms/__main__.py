...
from harp_notifications_sms.api.health import router as health
from harp_notifications_sms.api.notifications import router as notifications
from fastapi.middleware.cors import CORSMiddleware
from fastapi.exceptions import RequestValidationError
from fastapi.responses import JSONResponse
from fastapi.encoders import jsonable_encoder
from logger.logging import fastapi_logging
from harp_notifications_sms.plugins.tracer import get_tracer
